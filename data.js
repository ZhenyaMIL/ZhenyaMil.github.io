const theme_1 = [
  ...
  },
  {
    ...
    options: ["Sending e-mail messages", "Using a laptop during the winter", "Opening e-mail attachments",
      "Shopping on-line"
    ],
...
const theme_2 = [
  {
    id: "0",
    question: "Travel",
    options: ["Подорожувати", "кефір", "Молоко", "Завтра"],
    correct: "Подорожувати",
  },
  {
    id: "1",
    question: "Which is the only continent in the world without a desert?",
